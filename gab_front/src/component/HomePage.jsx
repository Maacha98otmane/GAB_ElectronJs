...
<div className="h-full flex flex-col bg-gray-100 dark:bg-gray-700 shadow-xl overflow-y-scroll">
  <div className="bg-green-300 shadow-lg pb-3 rounded-b-3xl">
    <div className="flex  rounded-b-3xl bg-gray-100 dark:bg-gray-700 space-y-5 flex-col items-center py-7">
      <img className="h-28 w-28 rounded-full" src="https://api.lorem.space/image/face?w=120&h=120&hash=bart89fe"
        alt="User" />
      <a href="m.fb.com"> <span className="text-h1">Michele</span></a>
    </div>
    <div className="flex flex-col items-center justify-center">
      <div className="col-span-1 flex flex-col items-center ">
        <span className="text-2xl font-bold dark:text-gray-500">2999 Dhs</span>
        <span className="text-lg font-medium 0">Balance</span>
      </div>
    </div>
  ...
  <div className="grid rounded-2xl divide-y divide-dashed hover:divide-solid  justify-evenly bg-gray-50 dark:bg-gray-300 m-3 mt-10 grid-cols-3">
    <div className="col-span-1  p-3">
      <div className="flex flex-col items-center ">
        <a href="m.fb.com"> <button className="tr-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-gray-500" fill="none" viewBox="0 0 24 24"
    ...
    <div className="col-span-1  p-3">
      <div className="flex flex-col items-center ">
        <a href="m.fb.com"> <button className="tr-300">
            ...
            <span className="text-lg font-medium">My history</span>
          </button></a>
      </div>
    </div>
    <div className="col-span-1  p-3">
